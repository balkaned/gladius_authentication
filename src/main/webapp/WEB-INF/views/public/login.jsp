                ...
                <div class="row align-items-center gx-0 gy-7">
                  <div class="col-auto bg-100 dark__bg-1100 rounded-3 position-relative overflow-hidden auth-title-box">
                    ...
                    <div class="position-relative px-4 px-lg-7 pt-7 pb-7 pb-sm-5 text-center text-md-start pb-lg-7 pb-md-7">
                      ...
                      <p style="font-size:12px;" class="text-700">GLADIUS HR para la gestión de información del trabajador, procesos de cálculo de planillas y los procesos siguientes como integración contable, reporte a SUNAT PLAME, reporte a ministerio de trabajo, reportes de AFP Net y otros reportes.</p>
                  ...
                  <div class="col mx-auto">
                    <div class="auth-form-box">
                      <div class="text-center mb-7"><a class="d-flex flex-center text-decoration-none mb-4" href="../../../index.html">
                        ...
                        <p class="text-700">Obtenga sus credenciales, accesos a su cuenta e inicie sesión, luego le redireccionaremos a su entorno según sus datos</p>
                      </div>
